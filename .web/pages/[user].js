...
{state.logged_in ? <Center><VStack><Text>{state.user_page}</Text></VStack></Center> : <Center sx={{"shadow": "lg", "padding": "1em", "borderRadius": "lg", "background": "white"}}><VStack><Input type="text"
placeholder="Userid"
