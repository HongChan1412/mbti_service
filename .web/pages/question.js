...
<Fragment>{state.logged_in ? <Fragment><Box sx={{"shadow": "lg", "padding": "1em", "borderRadius": "lg", "background": "white"}}><VStack><Heading>{("\uc9c8\ubb38" + state.question_idx)}</Heading>
...
<VStack spacing="1em"
sx={{"minWidth": ["10em", "20em"]}}><Progress sx={{"width": "100%"}}
value={state.question_progress}/></VStack></VStack></Box></Fragment> : <Fragment><Center sx={{"shadow": "lg", "padding": "1em", "borderRadius": "lg", "background": "white"}}><VStack><Input onBlur={(_e) => Event([E("state.set_userid", {userid:_e.target.value})])}
placeholder="Userid"
sx={{"width": "100%"}}
type="text"/>
